...
RSpec.describe 'PostsController', type: :request do
  user = User.create(name: 'Waris',
                     photo: 'https://yagankar.com/storage/avatars/287_sfqVYTzjweOQJvBqOSunbAaMR1rHRNcbXxU7FcV2.jpg', bio: 'Software Developer', posts_counter: 5)
  subject do
